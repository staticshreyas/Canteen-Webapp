...
const App = () => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(GlobalStyle, null), _react.default.createElement(_designSystem.Box, {
    height: "100%",
    flex: true
  }, sidebarVisible ? _react.default.createElement(_designSystem.Overlay, {
    onClick: () => toggleSidebar(!sidebarVisible)
  }) : null, _react.default.createElement(_sidebar.default, {
    ...
    position: "absolute",
    top: 0
  }, _react.default.createElement(_notice.default, null)), _react.default.createElement(_reactRouterDom.Switch, null, _react.default.createElement(_reactRouterDom.Route, {
    path: h.dashboardUrl(),
    exact: true,
  ...
  })), _react.default.createElement(_designSystem.Drawer, {
    id: "drawerPortal",
    className: "hidden"
  }))));
};
