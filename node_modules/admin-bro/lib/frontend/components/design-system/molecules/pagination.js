...
const Pagination = props => {
  ...
  return _react.default.createElement(PaginationWrapper, _extends({
    className: (0, _cssClass.cssClass)('Pagination')
  }, rest), _react.default.createElement(PaginationLink, {
    disabled: isFirstPage,
    onClick: () => !isFirstPage ? onChange(prevPage) : undefined
  }, _react.default.createElement(_icon.Icon, {
    icon: "ChevronLeft"
  })), paginate.pages.map(p => _react.default.createElement(PaginationLink, {
    key: p,
    onClick: () => onChange(p),
    variant: p === currentPage ? 'primary' : 'text'
  }, p)), _react.default.createElement(PaginationLink, {
