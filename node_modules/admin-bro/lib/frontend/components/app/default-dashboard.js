...
const DashboardHeader = () => {
  ...
  return _react.default.createElement(_designSystem.Box, {
    ...
    textAlign: "center",
    color: "white"
  }, _react.default.createElement(_designSystem.H2, null, translateMessage('welcomeOnBoard_title')), _react.default.createElement(_designSystem.Text, {
    opacity: "0.8"
...
const Dashboard = () => {
  ...
  return _react.default.createElement(_designSystem.Box, null, _react.default.createElement(DashboardHeader, null), _react.default.createElement(_designSystem.Box, {
    mt: ['xl', 'xl', '-100px'],
    mb: "xl",
    mx: [0, 0, 0, 'auto'],
    px: ['default', 'lg', 'xxl', '0'],
  ...
  _react.default.createElement(_designSystem.Box, {
    ...
    mt: "lg"
  }, box.title), _react.default.createElement(_designSystem.Text, null, box.subtitle))))), _react.default.createElement(_designSystem.Box, {
    width: [1, 1, 1 / 2],
    p: "lg"
  }, _react.default.createElement(Card, {
    as: "a",
    ...
    ml: "xl"
  }, _react.default.createElement(_designSystem.H4, null, translateMessage('checkoutBlog_title')), _react.default.createElement(_designSystem.Text, null, translateMessage('checkoutBlog_subtitle'))))), _react.default.createElement(_designSystem.Box, {
    width: [1, 1, 1 / 2],
    p: "lg"
  }, _react.default.createElement(Card, {
    as: "a",
    ...
    ml: "xl"
  }, _react.default.createElement(_designSystem.H4, null, translateMessage('foundBug_title')), _react.default.createElement(_designSystem.Text, null, translateMessage('foundBug_subtitle'))))), _react.default.createElement(_designSystem.Box, {
    variant: "white",
    boxShadow: "card",
    width: 1,
    m: "lg"
  ...
  }), _react.default.createElement(_designSystem.H4, null, translateMessage('needMoreSolutions_title')), _react.default.createElement(_designSystem.Text, null, translateMessage('needMoreSolutions_subtitle')), _react.default.createElement(_designSystem.Text, {
    mt: "xxl"
